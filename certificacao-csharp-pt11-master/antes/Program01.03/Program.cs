...
namespace Program01._03
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            System.Console.WriteLine("Completou sem interrupção? {0}", resultadoLoop.IsCompleted);
            //Tarefa 3: Interromper quando começar a processar o valor 75

            //Tarefa 4: Quantos itens foram processados (parcialmente)?
            System.Console.WriteLine("Quantos itens foram processados (parcialmente)? {0}", resultadoLoop.LowestBreakIteration);
